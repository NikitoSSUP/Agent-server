...
namespace AgentClient {
	...
	/// <summary>
	/// Ñâîäêà äëÿ allowedprograms
	/// </summary>
	public ref class allowedprograms : public System::Windows::Forms::Form
	{
	public:
		allowedprograms(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ñÏÈÑÎÊÏÎËÜÇÎÂÀÒÅËÅÉToolStripMenuItem->Click += gcnew System::EventHandler(this, &allowedprograms::ñÏÈÑÎÊÏÎËÜÇÎÂÀÒÅËÅÉToolStripMenuItem_Click);
			// 
			...
			this->ñÏÈÑÎÊĞÀÇĞÅØÅÍÍÛÕÏĞÎÃĞÀÌÌToolStripMenuItem->Click += gcnew System::EventHandler(this, &allowedprograms::ñÏÈÑÎÊĞÀÇĞÅØÅÍÍÛÕÏĞÎÃĞÀÌÌToolStripMenuItem_Click);
			// 
			...
			this->ñÏÈÑÎÊÇÀÏÅÙÅÍÍÛÕÏĞÎÃĞÀÌÌToolStripMenuItem->Click += gcnew System::EventHandler(this, &allowedprograms::ñÏÈÑÎÊÇÀÏÅÙÅÍÍÛÕÏĞÎÃĞÀÌÌToolStripMenuItem_Click);
			// 
			...
			this->ëÎÃÈToolStripMenuItem->Click += gcnew System::EventHandler(this, &allowedprograms::ëÎÃÈToolStripMenuItem_Click);
			// 
			...
			this->îÒÑËÅÆÅÍÀÍÈÅÄÅÉÑÒÂÈÉToolStripMenuItem->Click += gcnew System::EventHandler(this, &allowedprograms::îÒÑËÅÆÅÍÀÍÈÅÄÅÉÑÒÂÈÉToolStripMenuItem_Click);
			// 
			// dataGridView1
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(875, 423);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(141, 61);
			this->button2->TabIndex = 15;
			this->button2->Text = L"Óäàëèòü";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &allowedprograms::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(1022, 423);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(141, 61);
			this->button1->TabIndex = 14;
			this->button1->Text = L"Äîáàâèòü";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &allowedprograms::button1_Click);
			// 
			// textBox2
			// 
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox2->Location = System::Drawing::Point(112, 461);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox1->Location = System::Drawing::Point(112, 423);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(13, 462);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(72, 22);
			this->label2->TabIndex = 17;
			this->label2->Text = L"Âåğñèÿ";
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(13, 423);
			...
			this->ClientSize = System::Drawing::Size(1175, 505);
			...
			this->Name = L"allowedprograms";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"allowedprograms";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &allowedprograms::allowedprograms_FormClosing);
			this->Load += gcnew System::EventHandler(this, &allowedprograms::allowedprograms_Load);
...
#pragma endregion
	private: System::Void allowedprograms_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e);
    ...
    private: System::Void allowedprograms_Load(System::Object^ sender, System::EventArgs^ e);
};
}
