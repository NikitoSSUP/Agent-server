...
void main(array<String^>^ args) {
	...
	AgentClient::Load form;
	Application::Run(% form);
}

System::Void AgentClient::Load::timer1_Tick(System::Object^ sender, System::EventArgs^ e)
{
    ticks++;
    switch (ticks)
    {
    ...
    case 80:this->Hide(); Agent^ f = gcnew Agent; f->Show();
    }
}

System::Void AgentClient::Load::Load_Load(System::Object^ sender, System::EventArgs^ e)
{
}

System::Void AgentClient::Load::Load_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e)
{
    return System::Void();
}
